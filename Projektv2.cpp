...
void Rysowanie(float rozmiar, float x, float y, char znak)
{
	...
	system("cls");
	int przesunieciey = 0;
	int przesunieciex1 = rozmiar; //prawa strona
	int przesunieciex2 = rozmiar; //lewa strona
	for (int z = i; z <= (i + rozmiar / 2); z++)
	{
		gotoxy(i + przesunieciex1, j + przesunieciey), cout << znak;
		gotoxy(i + przesunieciex2, j + przesunieciey), cout << znak; //boki
	...
	przesunieciex1 = rozmiar;
	przesunieciex2 = rozmiar;
	for (int z = i; z <= (i + rozmiar / 4); z++)
	{
		gotoxy(i + przesunieciex1, j + rozmiar / 4), cout << znak;
		gotoxy(i + przesunieciex2, j + rozmiar / 4), cout << znak; //srodek
		przesunieciex1++;
		przesunieciex2--;
	}
}
